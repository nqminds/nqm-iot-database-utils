...
module.exports = (function() {
   ...
   * @property  {Buffer|object} data - The ndarray data Buffer or Stream.
   * @property  {string} dtype - The ndarray data type @see {@link module:sqlite-constants.NDARRAY_DTYPES}.
    ...
    return new Promise((resolve, reject) => {
      ...
      for (const dataRow of data) {
        ...
        for (const keyValue of dataKeys) {
          ...
          // nd(typedBuffer, meta["s"], majorToStride(meta["c"], meta["s"]));
        }
