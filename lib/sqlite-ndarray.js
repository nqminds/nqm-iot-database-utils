...
module.exports = (function() {
  ...
  /**
   * Returns the numpy metadata from an ndarray instance
   * @function
   * @alias module:sqlite-ndarray.ndarrayToNumpy
   * @sync
   * @param {object} array - The ndarray input object
   * @returns {object} - The numpy metadata
   */
  ndamodule.ndarrayToNumpy = function(array) {
    ...
    return new Promise((resolve, reject) => {
      ...
      for (const dataRow of data) {
        ...
        for (const keyValue of dataKeys) {
          const meta = ndamodule.ndarrayToNumpy(dataRow[keyValue]);
