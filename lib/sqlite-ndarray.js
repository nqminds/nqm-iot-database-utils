 ...
 */
module.exports.getTypedBufferSize = function(numpyType, numpySize) {
 ...
 */
module.exports.getTypedArrayFromBuffer = function(buffer, dtype) {
  switch (dtype) {
 ...
 */
module.exports.getNdarrayMeta = function(data, dtype, shape, major, ftype) {
 ...
 */
module.exports.getNdarrayData = function(data, meta) {
  const ndData = {};
  ndData.data = data;
 ...
 */
module.exports.writeNdarrayMany = function(db, data, key) {
 ...
 */
module.exports.readNdarrayMany = function(db, data, key, type) {
  return new Promise((resolve, reject) => {
    const retData = [];
    const dataKeys = [].concat(key);
    ...
    for (const dataRow of data) {
      ...
      for (const keyValue of dataKeys) {
        ...
        // If the alignment sign is ommited asume littel endian
        if (meta.t.length === 1) {
          meta.t = `${alignment}${meta.t}`;
        } else if (meta.t[0] !== alignment && meta.t.length > 1) {
        ...
        const bufferSize = module.exports.getTypedBufferSize(meta.t, meta.s);
        let dataBuffer;
        ...
        try {
          ...
          if (path.isAbsolute(meta.p)) {
            ...
            filePath = path.join(db.dataFolder, meta.p);
          }
        ...
        newRow[keyValue] = module.exports.getNdarrayData(dataBuffer, meta);
      }
